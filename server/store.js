...
function getInitialData() {
  ...
  const students = [
    ...
    },
    {
      ...
      email: 'dimas.bagus@siswa.smk.belajar.id',
      jurusan: 'Desain Komunikasi Visual (DKV)',
      kelas: 'XII DKV 1',
      no_hp: '0815-5544-3322',
      cv_url: 'https://behance.net/dimasbagusart',
      status_verifikasi: 'Terverifikasi',
      catatan_verifikasi: 'Portofolio grafis dan motion graphics lengkap.',
    ...
    },
    {
      ...
      status_verifikasi: 'Terverifikasi',
      catatan_verifikasi: 'Sertifikat kompetensi MYOB terlampir.',
    ...
    },
    {
      ...
      cv_url: 'https://dribbble.com/claranindya',
    ...
    },
    {
      ...
      judul: 'UI/UX & Graphic Designer',
      jurusan_target: 'Desain Komunikasi Visual (DKV), Multimedia',
      tipe_kerja: 'WFH',
    ...
    },
    {
      ...
      judul: 'Teknisi Jaringan & IT Support',
      jurusan_target: 'Teknik Komputer & Jaringan (TKJ)',
      tipe_kerja: 'WFO',
    ...
    },
    {
      ...
      judul: 'Social Media & Content Creator',
      jurusan_target: 'Desain Komunikasi Visual (DKV), Multimedia',
      tipe_kerja: 'WFO',
      work_schedule: 'On-site kantor',
      lokasi_kota: 'Malang, Jawa Timur',
    ...
    },
    {
      ...
      judul: 'Data Entry & Financial Accounting Assistant',
      jurusan_target: 'Akuntansi & Keuangan (AKL)',
      tipe_kerja: 'WFO',
      work_schedule: 'On-site kantor',
    ...
    },
    {
      ...
      judul: '2D Animator & Digital Character Artist',
      jurusan_target: 'Desain Komunikasi Visual (DKV), Multimedia',
      tipe_kerja: 'Hybrid',
      work_schedule: 'Hybrid schedule',
      lokasi_kota: 'Bandung, Jawa Barat',
    ...
    },
    {
      ...
      judul: 'Digital Visual Merchandising & Branding Intern',
      jurusan_target: 'Desain Komunikasi Visual (DKV), Pemasaran',
      tipe_kerja: 'WFO',
      work_schedule: 'On-site kantor',
    ...
    // Page 3: Jobs 21 - 26
    {
      ...
      judul: 'Teknisi IoT & Sistem Sinyal Kereta Api',
      jurusan_target: 'Teknik Komputer & Jaringan (TKJ), Elektronika',
      tipe_kerja: 'WFO',
      work_schedule: 'On-site kantor',
      lokasi_kota: 'Bandung, Jawa Barat',
      kuota: 4,
    ...
    },
    {
      id: 22,
      company_id: 1, // Telkom
      judul: 'Cloud Infrastructure & Sysadmin Intern',
      jurusan_target: 'Teknik Komputer & Jaringan (TKJ), RPL',
      tipe_kerja: 'Hybrid',
      work_schedule: 'Hybrid schedule',
      lokasi_kota: 'Surabaya, Jawa Timur',
      kuota: 4,
    ...
    },
    {
      id: 24,
      company_id: 11, // Glow Design Studio
      judul: '3D Asset Modeler & Blender Artist',
      jurusan_target: 'Desain Komunikasi Visual (DKV), Animasi',
      tipe_kerja: 'WFH',
      work_schedule: 'Flexible schedule',
      lokasi_kota: 'Yogyakarta, DIY',
      kuota: 3,
    ...
    },
    {
      id: 26,
      company_id: 13, // Ruang Media Kreatif
      judul: 'Videographer & Creative Video Editor',
      jurusan_target: 'Desain Komunikasi Visual (DKV), Multimedia',
      tipe_kerja: 'WFO',
      work_schedule: 'On-site kantor',
      lokasi_kota: 'Surabaya, Jawa Timur',
    ...
    // Page 4: Jobs 27 - 32
    {
      id: 27,
      company_id: 10, // Astra International
      judul: 'Cyber Security & Network Defense Intern',
      jurusan_target: 'Teknik Komputer & Jaringan (TKJ), RPL',
      tipe_kerja: 'WFO',
      work_schedule: 'On-site kantor',
      lokasi_kota: 'Jakarta Pusat, DKI',
    ...
    },
    {
      id: 29,
      company_id: 4, // Bank Mandiri
      judul: 'Administrasi Operasional & Kliring Digital',
      jurusan_target: 'Akuntansi & Keuangan (AKL)',
      tipe_kerja: 'WFO',
      work_schedule: 'On-site kantor',
      lokasi_kota: 'Bekasi, Jawa Barat',
    ...
    },
    {
      id: 31,
      company_id: 5, // Kumata Studio
      judul: 'Storyboard & Visual Development Artist',
      jurusan_target: 'Desain Komunikasi Visual (DKV), Animasi',
      tipe_kerja: 'WFH',
      work_schedule: 'Flexible schedule',
      lokasi_kota: 'Bandung, Jawa Barat',
    ...
    },
    {
      id: 32,
      company_id: 7, // Paragon
      judul: 'Staff Quality Assurance Lab & Pengujian Formulasi',
      jurusan_target: 'Akuntansi & Keuangan (AKL), Farmasi Industri',
      tipe_kerja: 'WFO',
      work_schedule: 'On-site kantor',
      lokasi_kota: 'Tangerang, Banten',
      kuota: 4,
    ...
    // Page 5: Jobs 33 - 38
    {
      id: 33,
      company_id: 1, // Telkom
      judul: 'Network Field Technician Fiber Optic',
      jurusan_target: 'Teknik Komputer & Jaringan (TKJ)',
      tipe_kerja: 'WFO',
      work_schedule: 'On-site kantor',
      lokasi_kota: 'Malang, Jawa Timur',
    ...
    },
    {
      id: 35,
      company_id: 9, // CV Kreatif Digital
      judul: 'Creative Copywriter & Social Media Planner',
      jurusan_target: 'Desain Komunikasi Visual (DKV), Pemasaran',
      tipe_kerja: 'WFH',
      work_schedule: 'Flexible schedule',
      lokasi_kota: 'Surabaya, Jawa Timur',
    ...
    },
    {
      id: 36,
      company_id: 11, // Glow Design Studio
      judul: 'UI Design System & Mobile App Specialist',
      jurusan_target: 'Desain Komunikasi Visual (DKV), Multimedia',
      tipe_kerja: 'WFH',
      work_schedule: 'Flexible schedule',
      lokasi_kota: 'Yogyakarta, DIY',
    ...
    },
    {
      id: 37,
      company_id: 8, // Len Industri
      judul: 'Asisten Perakitan Solar Cell & Modul Surya',
      jurusan_target: 'Teknik Komputer & Jaringan (TKJ), Elektronika',
      tipe_kerja: 'WFO',
      work_schedule: 'On-site kantor',
      lokasi_kota: 'Bandung, Jawa Barat',
    ...
    },
    {
      id: 38,
      company_id: 13, // Ruang Media Kreatif
      judul: 'Graphic Designer Media Iklan & Billboard Digital',
      jurusan_target: 'Desain Komunikasi Visual (DKV)',
      tipe_kerja: 'WFO',
      work_schedule: 'On-site kantor',
      lokasi_kota: 'Malang, Jawa Timur',
      kuota: 3,
    ...
    // Page 6: Jobs 39 - 44
    {
      ...
      jurusan_target: 'Rekayasa Perangkat Lunak (RPL), DKV',
      tipe_kerja: 'Hybrid',
      work_schedule: 'Hybrid schedule',
      lokasi_kota: 'Jakarta Selatan, DKI',
      kuota: 4,
    ...
    },
    {
      id: 41,
      company_id: 4, // Bank Mandiri
      judul: 'Junior Accounting & Tax Filing Assistant',
      jurusan_target: 'Akuntansi & Keuangan (AKL)',
      tipe_kerja: 'WFO',
      work_schedule: 'On-site kantor',
      lokasi_kota: 'Surabaya, Jawa Timur',
    ...
    },
    {
      id: 43,
      company_id: 1, // Telkom
      judul: 'Technical Support & NOC Helpdesk Specialist',
      jurusan_target: 'Teknik Komputer & Jaringan (TKJ)',
      tipe_kerja: 'WFO',
      work_schedule: 'On-site kantor',
      lokasi_kota: 'Bandung, Jawa Barat',
    ...
    },
    {
      id: 44,
      company_id: 5, // Kumata Studio
      judul: '3D Lighting, Rendering & Compositing Intern',
      jurusan_target: 'Desain Komunikasi Visual (DKV), Animasi',
      tipe_kerja: 'Hybrid',
      work_schedule: 'Hybrid schedule',
      lokasi_kota: 'Bandung, Jawa Barat',
    ...
    },
    {
      id: 46,
      company_id: 9, // CV Kreatif Digital
      judul: 'Motion Graphic Advertising & Short Video Editor',
      jurusan_target: 'Desain Komunikasi Visual (DKV), Multimedia',
      tipe_kerja: 'WFH',
      work_schedule: 'Flexible schedule',
      lokasi_kota: 'Surabaya, Jawa Timur',
    ...
    },
    {
      id: 48,
      company_id: 7, // Paragon
      judul: 'Packaging Design & Sustainable Brand Identity',
      jurusan_target: 'Desain Komunikasi Visual (DKV)',
      tipe_kerja: 'Hybrid',
      work_schedule: 'Hybrid schedule',
      lokasi_kota: 'Tangerang, Banten',
    ...
    },
    {
      id: 1,
      company_id: 1, // Telkom
      judul: 'Junior Network & Fiber Optic Technician Intern',
      jurusan_target: 'Teknik Komputer & Jaringan (TKJ)',
      tipe_kerja: 'WFO',
      work_schedule: 'On-site kantor',
      lokasi_kota: 'Jakarta Pusat, DKI',
    ...
    },
    {
      id: 4,
      company_id: 4, // Bank Mandiri
      judul: 'Staf Administrasi Keuangan & Kliring Digital Cabang',
      jurusan_target: 'Akuntansi & Keuangan (AKL)',
      tipe_kerja: 'WFO',
      work_schedule: 'On-site kantor',
      lokasi_kota: 'Jakarta Pusat, DKI',
    ...
    },
    {
      id: 5,
      company_id: 5, // Kumata Studio
      judul: '2D Digital Illustrator & Background Artist',
      jurusan_target: 'Desain Komunikasi Visual (DKV), Animasi',
      tipe_kerja: 'Hybrid',
      work_schedule: 'Hybrid schedule',
      lokasi_kota: 'Bandung, Jawa Barat',
    ...
    },
    {
      id: 7,
      company_id: 7, // Paragon
      judul: 'Quality Assurance Lab & Asisten Formulasi Kosmetik',
      jurusan_target: 'Akuntansi & Keuangan (AKL), Kimia Industri',
      tipe_kerja: 'WFO',
      work_schedule: 'On-site kantor',
      lokasi_kota: 'Tangerang, Banten',
      kuota: 2,
    ...
    },
    {
      id: 8,
      company_id: 8, // Len Industri
      judul: 'Asisten Perakitan Panel Surya & PCB SMT Elektronika',
      jurusan_target: 'Teknik Komputer & Jaringan (TKJ), Elektronika',
      tipe_kerja: 'WFO',
      work_schedule: 'On-site kantor',
      lokasi_kota: 'Bandung, Jawa Barat',
  ...
  const applications = [
    ...
    },
    {
      ...
      catatan_hubin: 'Kuota jurusan AKL untuk cabang ini telah penuh oleh rombel sebelumnya. Silakan ajukan ke mitra BTPN Syariah atau Pegadaian.',
      nomor_surat_pengantar: null,
      catatan_perusahaan: null,
      portofolio_url: 'https://drive.google.com/file/d/nurul-porto/view',
      alasan_melamar: 'Tertarik mendalami tata kelola pembukuan akuntansi perbankan syariah dan kliring.',
  ...
  const placements = [
    ...
    },
    {
      ...
      guru_pembimbing: 'Endang Sulastri, S.Pd. (Guru DKV)',
      status: 'Aktif',
      nilai_industri: null,
      nilai_sekolah: null,
      sertifikat_no: null,
    ...
    // Historical Alumni Placements (Selesai)
    {
      ...
      guru_pembimbing: 'M. Ridwan, M.T. (Guru TKJ)',
      status: 'Selesai',
      nilai_industri: 94,
      nilai_sekolah: 92,
    ...
    },
    {
      ...
      guru_pembimbing: 'Dra. Hj. Nurhayati (Guru AKL)',
      status: 'Selesai',
      nilai_industri: 96,
      nilai_sekolah: 95,
  ...
  const reviews = [
    {
      ...
      student_kelas: 'XII TKJ 1',
      student_jurusan: 'Teknik Komputer & Jaringan (TKJ)',
    ...
    },
    {
      ...
      student_kelas: 'XII DKV 2',
      student_jurusan: 'Desain Komunikasi Visual (DKV)',
      student_sekolah: 'SMK Taruna Bangsa Kota Bekasi',
      company_id: 9,
    ...
    },
    {
      id: 4,
      student_id: 3,
      student_nama: 'Dimas Bagus Santoso',
      student_kelas: 'XII DKV 1',
      student_jurusan: 'Desain Komunikasi Visual (DKV)',
      student_sekolah: 'SMK Taruna Bangsa Kota Bekasi',
      company_id: 5,
      ...
      review_text: 'Bagi anak DKV dan Animasi, Kumata adalah tempat impian. Kita belajar standar pipeline produksi animasi yang tayang di televisi internasional. Art Director selalu memberi feedback konstruktif setiap pagi saat daily standup.',
    ...
    },
    {
      ...
      student_kelas: 'XII AKL 1',
      student_jurusan: 'Akuntansi & Keuangan Lembaga (AKL)',
      student_sekolah: 'SMK Taruna Bangsa Kota Bekasi',
      company_id: 4,
    ...
    },
    {
      id: 8,
      student_id: 7,
      student_nama: 'Clara Anindya Putri',
      student_kelas: 'XII DKV 2',
      student_jurusan: 'Desain Komunikasi Visual (DKV)',
      student_sekolah: 'SMK Taruna Bangsa Kota Bekasi',
      company_id: 11,
    ...
    },
    {
      ...
      student_kelas: 'XII Kimia 1',
      student_jurusan: 'Kimia Industri & Farmasi',
      student_sekolah: 'SMK Taruna Bangsa Kota Bekasi',
      company_id: 7,
